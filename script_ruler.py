...
# Configuration
download_path = "C:/Users/Thomas MONNIER/Documents/Projet DiAfrica/"
# Images
words_to_search = ['charlotte de mailly nesle']
nb_to_download = [10]
...
def search_and_save(text, number, first_position):
    ...
    driver = webdriver.Chrome() #Charlotte, mets safari, et vous devez télécharger le webdriver de votre moteur de recherche
    driver.get(url)
    headers = {}
